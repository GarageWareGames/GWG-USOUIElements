...
namespace GWG.UsoUIElements.Editor
{
    ...
    /// </remarks>
    [UxmlElement]
    public partial class UsoToolbarToggle : ToolbarToggle, IUsoUiElement
    {
...
#region UsoUiElement Implementation
        ...
        /// <summary>
        /// CSS class name applied to all UsoToolbarToggle instances for styling purposes.
        /// </summary>
        private const string ElementClass = "uso-toolbar-toggle";
        ...
        /// <summary>
        /// Initializes a new Instance of the UsoToolbarToggle class with default settings.
        /// Creates a toggle with USO framework integration enabled and no initial label text.
        /// </summary>
        public UsoToolbarToggle() : base()
        {
            InitElement();
        }

        /// <summary>
        /// Initializes a new Instance of the UsoToolbarToggle class with the specified field name.
        ...
        public UsoToolbarToggle(string fieldName) : base()
        {
            InitElement(fieldName);
        }

        /// <summary>
        /// Initializes a new Instance of the UsoToolbarToggle class with field name and label text.
        ...
        public UsoToolbarToggle(string fieldName, string fieldLabelText)
        {
            InitElement(fieldName);
            this.text = fieldLabelText;
        }

        /// <summary>
        /// Initializes a new Instance of the UsoToolbarToggle class with field name, label text, and returns a reference.
        ...
        public UsoToolbarToggle(string fieldName, string fieldLabelText, out UsoToolbarToggle newField)
        {
            InitElement(fieldName);
            this.text = fieldLabelText;
            newField = this;
        ...
        /// <summary>
        /// Initializes a new Instance of the UsoToolbarToggle class with field name, label text, and data binding configuration.
        ...
        public UsoToolbarToggle(string fieldName, string fieldLabelText, string fieldBindingPath, BindingMode fieldBindingMode)
        {
            InitElement(fieldName);
            this.text = fieldLabelText;
        ...
        /// <summary>
        /// Initializes a new Instance of the UsoToolbarToggle class with complete configuration and returns a reference.
        ...
        /// <param name="fieldBindingMode">The binding mode that controls data flow between source and target.</param>
        /// <param name="newField">Output parameter that receives a reference to the newly created toggle.</param>
        public UsoToolbarToggle(string fieldName, string fieldLabelText, string fieldBindingPath, BindingMode fieldBindingMode, out UsoToolbarToggle newField)
        {
            InitElement(fieldName);
            this.text = fieldLabelText;
            newField = this;
