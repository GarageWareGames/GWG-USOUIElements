...
This package is used as the base UI for all Garage-Ware Games applications written for Unity.
This system is designed to make the Unity Data Binding 
system much simpler to use.

Our implementation can be directly dropped into an existing UI Toolkit project by 
